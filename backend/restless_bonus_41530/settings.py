"""
Django settings for restless_bonus_41530 project.
...
ROOT_URLCONF = 'restless_bonus_41530.urls'
...
WSGI_APPLICATION = 'restless_bonus_41530.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_bonus_41530 API",
    "DESCRIPTION": "API documentation for restless_bonus_41530 App",
    "VERSION": "v1",
}
